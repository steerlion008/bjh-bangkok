...
"[project]/src/app/api/table-size-options/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const DEFAULT_TABLE_SIZE_OPTIONS = [
    ...
    },
    {
        id: 2,
        size_value: 200,
        size_label: "เล็ก (200px)",
        sort_order: 2
    },
    {
        id: 3,
        size_value: 500,
        size_label: "กลาง (500px)",
        sort_order: 3
    },
    {
        id: 4,
        size_value: 800,
        size_label: "ใหญ่ (800px)",
        sort_order: 4
    },
    {
        id: 5,
        size_value: 1200,
        size_label: "ใหญ่มาก (1200px)",
        sort_order: 5
    }
];
...
async function GET() {
    try {
        ...
        if (!process.env.DATABASE_URL) {
            console.warn("DATABASE_URL not configured, using default table size options");
        ...
        try {
            const result = await client.query(`SELECT id, size_value, size_label, sort_order 
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fefdcd00._.js.map