...
"[project]/src/app/api/facebook-ads-balance-page2/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const accessToken = "EAAPb1ZBYCiNcBPzNxxSUntCZCTVHyl5AkAZBIiwCmDzrWKMLU4VEHJxRve7oqUDSaMs8om9pdVWFLzUdeTbTvkGPuTeuQ4KvGFizMy3VsSid8vgmjZB8OMoLySRmXxyAUpAwyyhSqOO8tSZAU6IYpxarsXBbZCDzFdy8u279HxSXtyWMpIolRtjJEWLdmfU5SwZCsP5";
        const adAccountId = "act_869492750129928";
        // Fields ที่ต้องดึง
        const fields = "account_id,name,account_status,balance,amount_spent,currency,funding_source_details,min_daily_budget,spend_cap";
        ...
        console.log("[Page 2 Balance API] Fetching from:", apiUrl.replace(accessToken, "***TOKEN***"));
        ...
        console.log("[Page 2 Balance API] Success - Balance:", balance, data.currency);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: {
                ...
                available_balance: balance > 0 ? balance : Math.max(0, spendCap - amountSpent)
            }
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b9adbc4f._.js.map