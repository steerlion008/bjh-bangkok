...
const serviceData = {
  eye: {
    ...
    titleTh: "ศัลยกรรมตา",
    subtitle:
      "Eyelid surgery performed by board-certified oculoplastic surgeons",
  ...
  rhinoplasty: {
    ...
    image:
      "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=1920",
    procedures: [
      {
        name: "Open rhinoplasty (lite)",
        nameTh: "เสริมจมูก (ไลท์)",
        price: "เริ่มต้น ฿15,900",
      },
      {
        name: "Open rhinoplasty (full refinement)",
        nameTh: "เสริมจมูก (ฟูล)",
        price: "เริ่มต้น ฿39,900",
      },
      {
        name: "Open rhinoplasty (standard)",
        nameTh: "เสริมจมูก (มาตรฐาน)",
    ...
    addons: [
      ...
      "Hump rasping & osteotomy",
      "Interdomal sutures",
      "Ear cartilage tip support",
      "Nasal tip defatting",
      "Alar base reduction",
    ],
  },
  facelift: {
    ...
    procedures: [
      {
        name: "Endoscopic upper facelift",
        nameTh: "ดึงหน้าส่วนบน",
        price: "เริ่มต้น ฿149,000",
      },
      {
        name: "Midface facelift",
        nameTh: "ดึงหน้าส่วนกลาง",
        price: "เริ่มต้น ฿59,000",
      },
      {
        name: "Lower facelift",
        nameTh: "ดึงหน้าส่วนล่าง",
        price: "เริ่มต้น ฿79,000",
      },
  ...
  pterygium: {
    ...
    subtitle:
      "Opening the door to a new era of eye care – Safety and world-class standards guaranteed",
    subtitleTh:
      "ก้าวเข้าสู่ยุคใหม่แห่งการดูแลดวงตา รับประกันความปลอดภัย มาตรฐานระดับสากล",
    image: "https://images.unsplash.com/photo-1551601651-2a8555f1a136?w=1920",
    procedures: [
      {
        name: "Pterygium excision with sutures",
        nameTh: "ผ่าตัดต้อเนื้อแบบเย็บ",
        price: "เริ่มต้น ฿9,900",
      },
      {
        name: "Pterygium excision with fibrin glue",
        nameTh: "ผ่าตัดต้อเนื้อแบบกาว",
        price: "เริ่มต้น ฿25,900",
      },
    ],
    benefits: [
        ...
        <div className="container">
          ...
          >
            ...
            <p className="section-subtitle">
              ตัวเลือกเสริมเพื่อผลลัพธ์ที่ดียิ่งขึ้น
            </p>
          </motion.div>
